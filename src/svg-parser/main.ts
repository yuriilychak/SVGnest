...
import { PolyFillType, Clipper } from "../clipper";
...
export default class SvgParser {
  ...
  _svgToClipper(polygon: IPolygon, clipperScale: number): Point[] {
    const result = [];
    let i = 0;
  ...
  private _clipperToSvg(polygon: Point[], clipperScale: number): IPolygon {
