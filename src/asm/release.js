  ...
  const adaptedExports = Object.setPrototypeOf(
    {
      lineIntersect(importA, importB, importE, importF, infinite) {
        ...
        importA = __retain(
          __lowerTypedArray(Float32Array, 4, 2, importA) || __notnull()
        );
        importB = __retain(
          __lowerTypedArray(Float32Array, 4, 2, importB) || __notnull()
        );
        importE = __retain(
          __lowerTypedArray(Float32Array, 4, 2, importE) || __notnull()
        );
      ...
      segmentDistance(inputA, inputB, inputE, inputF, inputDirection) {
        ...
        inputA = __retain(
          __lowerTypedArray(Float32Array, 4, 2, inputA) || __notnull()
        );
        inputB = __retain(
          __lowerTypedArray(Float32Array, 4, 2, inputB) || __notnull()
        );
        inputE = __retain(
          __lowerTypedArray(Float32Array, 4, 2, inputE) || __notnull()
        );
        inputF = __retain(
          __lowerTypedArray(Float32Array, 4, 2, inputF) || __notnull()
        );
        inputDirection =
          __lowerTypedArray(Float32Array, 4, 2, inputDirection) || __notnull();
        try {
