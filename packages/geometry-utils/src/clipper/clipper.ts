...
export default class Clipper extends ClipperBase {
    ...
    public execute(clipType: CLIP_TYPE, solution: PointF64[][], fillType: POLY_FILL_TYPE): boolean {
        ...
        while (this.currentLM !== null && this.currentLM.y === botY) {
            ...
            if (outPt !== null && rightBound.isHorizontal && this.ghostJoins.length > 0 && !rightBound.isWindDeletaEmpty) {
                ...
                for (i = 0; i < joinCount; ++i) {
                    ...
                    if (PointF64.horzSegmentsOverlap(join.OutPt1.point, join.OffPt, rightBound.Bot, rightBound.Top)) {
    ...
    private intersectEdges(edge1: TEdge, edge2: TEdge, point: PointF64, isProtect: boolean): void {
    ...
    private AddLocalMinPoly(edge1: TEdge, edge2: TEdge, point: PointF64) {
    ...
    private buildResult(polygons: PointF64[][]): void {
        const polygonCount = this.polyOuts.length;
        let outRec: OutRec = null;
        let polygon: NullPtr<PointF64[]> = null;
        let i: number = 0;
        ...
        while (true) {
            ...
            while (e !== null) {
                ...
                if ((dir === DIRECTION.RIGHT && e.Curr.x <= horzRight) || (dir === DIRECTION.LEFT && e.Curr.x >= horzLeft)) {
                    ...
                    const Pt: PointF64 = PointF64.create(e.Curr.x, horzEdge.Curr.y);
    ...
    private prepareHorzJoins(horzEdge: TEdge, isTopOfScanbeam: boolean) {
        ...
        if (isTopOfScanbeam) {
            ...
            const offPoint: PointF64 = outPt.point.almostEqual(horzEdge.Top) ? horzEdge.Bot : horzEdge.Top;
