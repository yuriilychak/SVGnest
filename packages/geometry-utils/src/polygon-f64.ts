...
export default class PolygonF64 implements Polygon<Float64Array> {
    ...
    private bounds: BoundRectF64;

    private constructor() {
        this.point = PointF64.create();
        this.closed = false;
        this.pointCount = 0;
        this.offset = 0;
        this.rectangle = false;
        this.bounds = new BoundRectF64();
    }
    ...
    public pointIn(point: Point, offset: Point = null): boolean {
        ...
        const currPoint: PointF64 = PointF64.create();
        const prevPoint: PointF64 = PointF64.create();
        const pointCount: number = this.pointCount;
    ...
    public exportBounds(): BoundRectF64 {
