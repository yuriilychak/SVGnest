...
export default class BoundRectF64 implements BoundRect<Float64Array> {
    ...
    public clone(): BoundRectF64 {
        return new BoundRectF64(this._position.x, this._position.y, this._size.x, this._size.y);
    }
