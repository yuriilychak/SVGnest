    ...
    if (!('SVGPathSegList' in window) || !('appendItem' in window.SVGPathSegList.prototype)) {
        ...
        window.SVGPathSegList._pathSegArrayAsString = function(pathSegArray) {
            ...
            pathSegArray.forEach(pathSeg => {
                if (first) {
                    first = false;
                    string = string + pathSeg._asPathString();
                } else {
                    string = `${string } ${ pathSeg._asPathString()}`;
                }
            });
            ...
            Source.prototype._parseNumber = function() {
                ...
                if (this._currentIndex != startIntPartIndex) {
                    ...
                    while (scanIntPartIndex >= startIntPartIndex) {
                        integer = integer + multiplier * (this._string.charAt(scanIntPartIndex--) - '0');
                ...
                if (this._currentIndex < this._endIndex && this._string.charAt(this._currentIndex) == '.') {
                    ...
                    while (
                        ...
                        frac = frac * 10;
                        decimal = decimal + (this._string.charAt(this._currentIndex) - '0') / frac;
                ...
                if (
                    ...
                    while (
                        ...
                        exponent = exponent + (this._string.charAt(this._currentIndex) - '0');
                        this._currentIndex++;
                    }
                }
