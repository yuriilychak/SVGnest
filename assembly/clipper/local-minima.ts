...
export default class LocalMinima {
  ...
  private _right: TEdge | null = null;
  private _left: TEdge | null = null;

  constructor(y: f64, left: TEdge | null = null, right: TEdge | null = null) {
    this._y = y;
    this._left = left;
    this._right = right;
  }
  ...
  public clean(): void {
    if ((this._left as TEdge).outIndex == TEdge.skip) {
      this._left = null;
    } else if ((this._right as TEdge).outIndex == TEdge.skip) {
      this._right = null;
    }
  }
